...
class Prepro(PreProcessorBase):

    def __init__(self):
        self.df = None
        self.rs = scaler.Scaler()
        self.encoder = None
        self.cols_to_drop = []
    ...
    def set_drop_columns(self)

    def drop(self, columns):
        pass

    def replace_nan(self, alt):
        pass

    def standardize(self):
        pass

    def re_standardize(self):
        pass

    def replace_categorical_nan(self, alt):
        pass

    def encode(self, encoder):
        pass

    def re_encode(self, encoder):
        pass

    def save(self, path_train_prp):
        pass
    ...
    def exe(self, df, encoder='ordinal',
        ...
        if encoder == 'target':
            df_, self.encoder = enc.target_encode(df_, return_encoder=True)
